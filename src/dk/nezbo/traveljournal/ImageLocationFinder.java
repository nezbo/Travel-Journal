...
public class ImageLocationFinder implements LocationListener {
	...
	public static void initiate(Context c, AdvImage image, int seconds) {
		System.out.println("LOCATION: Estimation begun...");
	...
	private void init(int seconds) {
		...
		System.out.println("LOCATION: GPS init complete");
	}

	public void onLocationChanged(Location location) {
		System.out.println("LOCATION: GPS location recieved");
		if (currentBest == null)
			currentBest = location;

		// check for better
		if (this.isBetterLocation(location, currentBest))
			currentBest = location;
		...
		if (System.currentTimeMillis() > end) {
			...
			System.out.println("LOCATION: GPS position determined");
		}
	}
